...
export const PRE_QUESTIONS = [
  ...
  { id: 'investing_style_self_view', prompt: 'ถ้าต้องลงทุน คุณคิดว่าสไตล์คุณเป็นแบบไหน', options: [['2', ' กล้าเสี่ยง กล้าตัดสิน\u2060ใจ เพื่อหวังกำไรสูง'], ['0', ' เน้นปลอดภัย\u2028ได้กำไรน้อยก็ไม่เป็นไร'], ['1', ' ยืดหยุ่น\u2028ดูจังหวะ บางครั้งเสี่ยงบ้าง']] },
