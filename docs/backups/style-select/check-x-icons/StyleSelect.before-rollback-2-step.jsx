...
import checkmarkAsset from '../assets/ui/checkmark-transparent.png'
import crossAsset from '../assets/ui/cross-transparent.png'
            ...
            <div className="style-select-profile pixel-frame mt-3">
              ...
              <div className="style-select-pros-cons mt-2 space-y-1.5">
                <div className="flex gap-1.5 border-l-[3px] border-emerald-400 bg-emerald-500/10 px-2 py-1.5">
                  <img className="style-select-pros-cons__icon" src={checkmarkAsset} alt="" aria-hidden="true" />
                ...
                <div className="flex gap-1.5 border-l-[3px] border-rose-400 bg-rose-500/10 px-2 py-1.5">
                  <img className="style-select-pros-cons__icon" src={crossAsset} alt="" aria-hidden="true" />
